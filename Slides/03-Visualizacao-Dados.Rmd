...
<br><br><br><br>
## .font90[Visualização de dados <br> com ggplot2 e extensões] `r anicon::faa("pagelines", animate="horizontal", colour="green")`
...
## Objetivos
<br><br>
Ao final desta terceira parte (.blue[Visualização de dados com ggplot2 e extensões]) espera-se que os participantes possam alcançar conhecimentos para...
<br><br>
...
.pull-left-10[
.font80[
**Parte 1 - Visualização de dados com .orange[ggplot2]** .green[**(cont.)**]
...
.pull-down[
.font80[
**Parte 2 - Combinação de gráficos com .orange[Patchwork]**
...
.font200[**.yellow[Parte 2] <br> .white[Combinação de gráficos <br> com .orange[Patchwork]]**]

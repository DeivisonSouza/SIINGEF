...
Este repositório guarda os slides em .html, códigos R, arquivos .Rmd, figuras, conjunto de dados (e outros) utilizados no minicurso **Visualização de dados com ggplot2 e extensões** ministrado pelo **Prof. Dr. Deivison Venicio Souza** no **I Simpósio Internacional Interdisciplinar em Gestão Ambiental e Engenharia Florestal do Sul do Amapá**.

# Slides do minicurso

Os slides do minicurso **Visualização de dados com ggplot2 e extensões** estão detalhados a seguir.

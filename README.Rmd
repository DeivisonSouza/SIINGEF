...
Este repositório guarda os slides em .html, códigos R, arquivos .Rmd, figuras, conjunto de dados (e outros) utilizados no minicurso **Visualização de Dados com ggplot2** ministrado pelo **Prof. Dr. Deivison Venicio Souza** no **I Simpósio Internacional Interdisciplinar em Gestão Ambiental e Engenharia Florestal do Sul do Amapá**.

# Slides do minicurso

Os slides do minicurso **Visualização de Dados com ggplot2** estão detalhados a seguir.
